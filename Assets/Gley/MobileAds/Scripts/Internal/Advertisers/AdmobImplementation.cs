...
namespace Gley.MobileAds.Internal
{
    ...
    public class AdmobImplementation : MonoBehaviour, IAdProvider
    {
        ...
        {
            ShowBanner(bannerId, position, bannerType, customSize, customPosition);
        }
        ...
        public void ShowBanner(string bannerID, BannerPosition position, BannerType bannerType, Vector2Int customSize, Vector2Int customPosition)
        {
            ...
            if (banner != null)
            {
                ...
                {
                    LoadBanner(bannerID, position, bannerType, customSize, customPosition);
                }
            }
            else
            {
        ...
        private void LoadBanner(string bannerID, BannerPosition position, BannerType bannerType, Vector2Int customSize, Vector2Int customPosition)
        {
        ...
        {
            ShowBanner(mrecId, position, BannerType.MediumRectangle, new Vector2Int(), customPosition);
        }
